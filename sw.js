const CACHE='m-beauty-road-v1';
const CORE=['./','./index.html','./assets/app.css','./assets/app.js','./data/photos.json','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
